...
public class RectangleTest extends TestCase {
  ...
  public void testLongAndShortSides() {
    Rectangle rectangle = new Rectangle(Color.GRAY, new Point(1.2,1.25), "rectanlge", 3.1, 3.5);
  ...
  public void testLongAndShortSidesWithNegative() {
    Rectangle rectangle = new Rectangle(Color.GRAY, new Point(1.2,1.25), "rectanlge", 3.7, -3.2);
  ...
  public void testGetArea() {
    Rectangle rectangle = new Rectangle(Color.GRAY, new Point(1.2,1.25), "rectanlge", 3.0, 4.0);
